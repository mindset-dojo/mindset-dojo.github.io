...
### Purpose
Mindset Dojo is an open-source dojo for practicing the shift from intention to action. If you want a gentle first step, fork this repo, light up a GitHub Pages site, and publish your first author card and Insight article.
...
4. Prefer an in-browser workspace? Use **GitHub Codespaces** from the repo header to edit without installing anything locally.
