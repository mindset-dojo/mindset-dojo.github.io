...
A host community invites a Mindset Dojo pair to lead or present. Roles are complementary:

- **Primary Presenter** — sets tone, narrative, and energetic direction  
- **Supporting Presenter** — stabilizes the field, anchors timing, and facilitates breakouts or reflection
...
- **Breakout Practice**  
  Small groups explore a focused drill or reflection prompt to deepen embodied understanding.

- **Integration & Reflection**  
  Close with *Dynamic Silence* and *Wisdom of the Crowd*, harvesting insights from the shared field.
