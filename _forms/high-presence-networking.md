...
- [Zen Leadership: Off the Cushion](https://zenleader.global/events) — where embodiment and leadership intersect in practice.  
- [Chosei Zen](https://www.choseizen.org/) — a community devoted to integrating Zen, science, and leadership.  
- [Japanese Culture Center / Tenshinkan Dojo](https://japaneseculturecenter.com/classes/aikido) — physical and spiritual training in the art of Aikido.  
- [InnerSource Commons Foundation](https://innersourcecommons.org/) — an open source community cultivating collaboration within organizations.  
- [Fearless Change](https://www.fearlesschangepatterns.com/) — a global pattern language community focused on culture, change, and human connection.  
- [Cloud Security Office Hours](https://csoh.org/) — where technology and humanity meet through inquiry and shared intelligence.  
